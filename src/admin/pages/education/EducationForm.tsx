            ...
            <div className="md:col-span-2 space-y-6">
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <Label className="font-semibold">Deskripsi Lengkap (HTML & Rich Text)</Label>
                            <RichHtmlEditor 
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                <div className="h-10 w-10 rounded-full border bg-muted flex items-center justify-center overflow-hidden flex-shrink-0">
                                    {formData.logo ? <img src={formData.logo} className="h-full w-full object-contain rounded-full p-1" /> : <ImageIcon className="h-4 w-4 text-muted-foreground" />}
                                </div>
                                <Input 
                                    value={formData.logo} 
