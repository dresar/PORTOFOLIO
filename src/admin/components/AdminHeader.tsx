...
import { LogOut, User, Settings, ExternalLink, Menu, ImageIcon } from "lucide-react";
...
export default function AdminHeader({ onToggleSidebar, onOpenMediaPicker }: AdminHeaderProps) {
            ...
            <DropdownMenuLabel className="font-normal">
              <div className="flex flex-col space-y-1">
                ...
                <p className="text-xs leading-none text-muted-foreground">
                  {user?.email || "eka.ckp16799@gmail.com"}
                </p>
              </div>
            </DropdownMenuLabel>
            <DropdownMenuSeparator />
