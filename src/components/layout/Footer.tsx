...
export const Footer = () => {
  ...
  return (
    <footer className="border-t border-border/80 bg-card/40 relative overflow-hidden">
      <div className="container mx-auto px-4 max-w-6xl pt-14 pb-12">
        <div className="mb-14 p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-card via-card/80 to-card border border-border/80 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6 hover:border-primary/40 transition-colors">
          <div className="space-y-2 text-center md:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-primary/10 border border-primary/20 text-primary text-[11px] font-bold uppercase tracking-wider">
              <Zap className="w-3.5 h-3.5" />
              <span>{isId ? 'SIAP UNTUK TANTANGAN REKAYASA BARU' : 'READY FOR NEW ENGINEERING CHALLENGES'}</span>
            </div>
            <h3 className="text-xl sm:text-2xl font-heading font-extrabold tracking-tight text-foreground">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            <a
              ...
              className="h-10 px-4 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs sm:text-sm font-semibold flex items-center gap-2 transition-all shadow-xs active:scale-[0.98]"
            >
            ...
            <a
              href="#projects"
              className="h-10 px-4 rounded-lg bg-background border border-border/80 hover:border-primary text-foreground text-xs sm:text-sm font-semibold flex items-center gap-1.5 transition-all shadow-xs active:scale-[0.98]"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10 pb-12 border-b border-border/60">
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-muted/50 border border-border/60 text-[11px] font-semibold text-foreground">
                ...
                <li key={res.label}>
                  {res.isExternal ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-muted-foreground hover:text-primary transition-colors flex items-center justify-between py-0.5 group"
                    >
                      <span className="truncate">{res.label}</span>
                      <span className="text-[9px] font-mono px-1.5 py-0.5 rounded bg-muted text-muted-foreground group-hover:text-primary group-hover:bg-primary/10 transition-colors shrink-0">
                        {res.badge}
                      </span>
                    </a>
                  ) : (
          ...
          <div className="flex items-center gap-1.5">
            {normalizedSocialLinks.map((link) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="h-8 w-8 rounded-lg bg-background border border-border/60 hover:border-primary hover:text-primary flex items-center justify-center transition-all text-muted-foreground active:scale-[0.98]"
