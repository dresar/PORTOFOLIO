      ...
      >
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <motion.a
            ...
            aria-label="Eka Syarif Maulana - Kembali ke beranda"
            title="Eka Syarif Maulana - Beranda"
          >
          ...
          {/* Desktop Navigation */}
          <nav
            className="hidden md:flex items-center gap-1 p-1.5 rounded-full border border-border/40 bg-background/50 backdrop-blur-md shadow-sm"
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col h-full p-4">
              ...
              <nav className="flex flex-col gap-4 flex-1 justify-center items-center" aria-label="Navigasi mobile">
