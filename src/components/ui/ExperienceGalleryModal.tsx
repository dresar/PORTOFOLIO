                    ...
                    {experienceGallery[currentImageIndex] ? (
                        <img 
                            ...
                            onClick={() => {
                              ...
                              const currentSrc = typeof experienceGallery[currentImageIndex] === 'string' ? normalizeMediaUrl(experienceGallery[currentImageIndex]) : normalizeMediaUrl(experienceGallery[currentImageIndex].url);
