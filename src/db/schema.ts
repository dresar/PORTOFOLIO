...
export const educations = pgTable(
  'educations',
  {
    ...
    degree: varchar('degree', { length: 100 }).default('-').notNull(),
    fieldOfStudy: varchar('field_of_study', { length: 150 }).default('-').notNull(),
    startDate: varchar('start_date', { length: 50 }).default('-').notNull(),
...
export const skills = pgTable(
  'skills',
  {
    ...
    category: varchar('category', { length: 100 }).default('Frontend').notNull(),
    iconClass: varchar('icon_class', { length: 100 }).default('fa-solid fa-code').notNull(),
...
export const experiences = pgTable(
  'experiences',
  {
    ...
    role: varchar('role', { length: 150 }).default('-').notNull(),
...
export const certificates = pgTable(
  'certificates',
  {
    id: uuid('id').defaultRandom().primaryKey(),
    title: varchar('title', { length: 200 }).notNull(),
    issuer: varchar('issuer', { length: 150 }).default('-').notNull(),
    issueDate: varchar('issue_date', { length: 50 }).default('-').notNull(),
...
export const contactMessages = pgTable(
  'contact_messages',
  {
    ...
    subject: varchar('subject', { length: 255 }).default('Pesan Baru dari Website').notNull(),
